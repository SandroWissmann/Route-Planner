...
// TODO 5: Complete the NextNode method to sort the open list and return
// the next node.
// Tips:
...
// - The returned vector should be in the correct order: the start node
...
// - Use the NextNode() method to sort the open_list and return the next
// node.
